...
const statusColors: Record<string, string> = {
  ...
  InTransit: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400',
  CustomsClearance: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
  OutForDelivery: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-400',
  Delivered: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  Cancelled: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400',
  Available: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  InUse: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400',
  Maintenance: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
  Inactive: 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400',
  Normal: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  LowStock: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
